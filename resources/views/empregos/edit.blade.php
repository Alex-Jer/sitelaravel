      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">Editar Emprego</li>
          </ol>
        </div>
      </div>
    </div><!-- /.container-fluid -->
        ...
        <div class="col-md-12">
          ...
          <div class="card card-primary">
            <div class="card-header">
              <h3 class="card-title">Editar Emprego</h3>
            </div>
            <!-- /.card-header -->
            <!-- form start -->
              ...
              <div class="card-body">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="designacao" id="designacao"
                    ...
                    value="{{ empty(old('designacao')) ? $emprego->designacao : old('designacao') }}" required>
                  @error('designacao')
                  <p class="text-danger">
                ...
                <div class="form-group">
                  ...
                  <select class="form-control select2" name="localidade" id="localidade">
                    ...
                    @if ($emprego->localidades_id == $localidade->id)
                ...
                <div class="form-group">
                  ...
                  <select class="form-control select2" name="empresa" id="empresa">
                    ...
                    @if ($emprego->empresas_id == $empresa->id)
                ...
                <div class="form-group">
                  ...
                  <select class="form-control select2" name="categoria" id="categoria">
                    ...
                    @if ($emprego->categorias_id == $categoria->id)
                ...
                <div class="form-group">
                  ...
                  <textarea name="descricao" id="descricao" class="form-control" rows="3"
                    ...
                    required>{{ empty(old('descricao')) ? $emprego->descricao : old('descricao') }}</textarea>
                  @error('descricao')
                  <p class="text-danger">
